...
public class LeaderboardStatisticsActivity extends AppCompatActivity {

    private final static String TAG = "LeaderboardStatisticsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistics_dialog);
        ...
        TextView player_name = (TextView) findViewById(R.id.player_name_tv);
